...
4. Compute power spectra and galactic mask-deconvolved power spectra of each component.
...
6. Reproject from HEALPIX to CAR.  
    - Computed in [reprojection.py](reprojection.py) and saved as sim_{freqs}GHz.  
7. Make plots. 
